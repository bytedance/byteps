...
def get_common_options(build_ext):
    ...
    SOURCES = ['byteps/common/common.cc',
               ...
               'byteps/common/compressor/compressor.cc',
               ...
               'byteps/common/compressor/impl/efsignsgd.cc',
               'byteps/common/compressor/impl/randomk.cc',
               'byteps/common/compressor/impl/dgc.cc',
               'byteps/common/compressor/impl/topk.cc',
               'byteps/common/compressor/impl/none.cc',
