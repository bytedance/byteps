  ...
  do
      ...
      do
          ...
          if [ ${pcie} -eq 0 ]; then
            ...
            scheduler_file="../../mergeComp/scheduler/lstm/pcie_${compressor}_two_cpu"
          fi
          BENCHMARK_ARGS="--compress --compressor ${compressor} --memory topk --comm ${communicator} --compress-ratio ${compress_ratio} --scheduler-file ${scheduler_file} --scheduler-type -1"
...
hdfs dfs -mkdir hdfs://haruna/byte_search/user/zhuangwang/bytecomp/lstm
