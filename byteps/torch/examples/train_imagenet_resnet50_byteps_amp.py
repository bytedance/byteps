...
parser.add_argument('--train-dir', default=os.path.expanduser('~/zhuang/imagenette2/train/'),
                    help='path to training data')
parser.add_argument('--val-dir', default=os.path.expanduser('~/zhuang/imagenette2/val/'),
