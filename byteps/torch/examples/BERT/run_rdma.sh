...
export DMLC_PS_ROOT_URI="10.130.24.135"
export DMLC_NODE_HOST="$(/sbin/ip -o -4 addr list eth2 | awk '{print $4}' | cut -d/ -f1)"
...
BERT_ARGS+=" --examples_limit=100000 "
BERT_ARGS+=" --log_freq=100 "
...
do 
  ...
  sleep 5
  python3 -m torch.distributed.launch $DISTRIBUTED_ARGS run_squad.py ${BERT_ARGS} --fp16 
done
