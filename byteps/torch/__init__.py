...
from byteps.torch.ops import intra_reduce_async, intra_reduce
from byteps.torch.ops import intra_gather_async, intra_gather, intra_allgather_async, intra_allgather, intra_alltoall, intra_alltoall_async
from byteps.torch.ops import intra_broadcast_async, intra_broadcast, intra_reducescatter_async, intra_reducescatter, cpu_compress, cpu_compress_async
    ...
    def synchronize(self):
        ...
        for p, (handle, _) in self._handles.items():
            ...
            if not self._enable_async:
                tensor = self._compression.decompress(output, ctx)
                with torch.no_grad():
                    grad.set_(tensor)
        self._handles.clear()
