...
enum BytePSCommSignal {
  ...
  INTRA_REDUCE_READY,
  INTRA_GATHER_READY,
  INTRA_BROADCAST_READY,
  INTRA_REDUCESCATTER_READY,
  INTRA_ALLGATHER_READY,
  INTRA_ALLTOALL_READY,
  NONE_READY,
  PCIE_REDUCE_READY,
  BCAST_READY,
  PUSH_READY,
  ...
  DO_COPYH2D,
  DO_COMPRESS_COPYH2D,
  // zhuang: comm signals for intra-node communication
  DO_INTRA_REDUCE,
  DO_INTRA_GATHER,
  DO_INTRA_BROADCAST,
  DO_INTRA_REDUCESCATTER,
  DO_INTRA_ALLGATHER,
  DO_INTRA_ALLTOALL
};
