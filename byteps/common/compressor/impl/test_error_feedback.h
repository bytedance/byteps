...
#ifndef BYTEPS_COMPRESSOR_IMPL_TEST_ERROR_FEEDBACK_H
#define BYTEPS_COMPRESSOR_IMPL_TEST_ERROR_FEEDBACK_H
 ...
 */
class TestErrorFeedbackCompressor : public ErrorFeedback {
 public:
  TestErrorFeedbackCompressor(size_t size, DataType dtype,
                                 std::unique_ptr<Compressor> cptr);
  virtual ~TestErrorFeedbackCompressor() = default;
...
#endif  // BYTEPS_COMPRESSOR_IMPL_TEST_ERROR_FEEDBACK_H