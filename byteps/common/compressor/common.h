...
/*
 * Because FP16 or uint16_t is not build-in data type for CPUs, we observed that the overheads of encoding/decoding operations 
 * on FP16 are costly. We convert FP16 to FP32 before encoding.
 */
