...
class BytePSGlobal {
 public:
  ...
  static bool IsTensorDeclared(const std::string& name, const size_t size=0);
  ...
  static std::string GetIntraCompressor() {return _intra_compressor;}
  static std::string GetInterCompressor() {return _inter_compressor;}
  static std::string GetCompressorErrorFeedback() {return _compressor_error_feedback;}
  static float GetCompressorSparsity() {return _compressor_k;}
  ...
  static ReadyTable* GetNoneTable() { return _none_table; }
  static ReadyTable* GetReduceTable() { return _reduce_table; }
  static ReadyTable* GetIntraReduceTable() { return _intra_reduce_table; }
  static ReadyTable* GetIntraGatherTable() { return _intra_gather_table; }
  static ReadyTable* GetIntraBroadcastTable() { return _intra_broadcast_table; }
  static ReadyTable* GetIntraReducescatterTable() { return _intra_reducescatter_table; }
  static ReadyTable* GetIntraAllgatherTable() { return _intra_allgather_table; }
  static ReadyTable* GetIntraAlltoallTable() { return _intra_alltoall_table; }
  ...
  static ReadyTable* GetCompressCopyTable() { return _compress_copy_table; }
  ...
  static void EmitTrace(std::ostream* os, const BPSCommTime* ret,
                        BPSContext* ctxt);
  static void EmitTensorReadyTrace(std::ostream* os, const BPSCommTime* ret,
                        BPSContext* ctxt);
 ...
 private:
  ...
  static std::string _intra_compressor;
  static std::string _inter_compressor;
  static std::string _compressor_error_feedback;
  static float _compressor_k;

  // (key, ready_signal_count) pair, only valid for root device
  static ReadyTable* _none_table;
  static ReadyTable* _reduce_table;
  static ReadyTable* _intra_reduce_table;
  static ReadyTable* _intra_gather_table;
  static ReadyTable* _intra_broadcast_table;
  static ReadyTable* _intra_reducescatter_table;
  static ReadyTable* _intra_allgather_table;
  static ReadyTable* _intra_alltoall_table;
  ...
  static ReadyTable* _compress_copy_table;
